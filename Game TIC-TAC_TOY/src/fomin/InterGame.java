package fomin;
//Тут происходит основная логика игры: соверается ход машины, проверка на победу, хранение статических ключевых параметров. По сути это набор интсрументов статических для базовой структуры игры.
